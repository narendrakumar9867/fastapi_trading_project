...
*/
-- AlterTable
ALTER TABLE "StockData" ALTER COLUMN "open" SET DATA TYPE DECIMAL(65,30),
ALTER COLUMN "high" SET DATA TYPE DECIMAL(65,30),
ALTER COLUMN "low" SET DATA TYPE DECIMAL(65,30),
ALTER COLUMN "close" SET DATA TYPE DECIMAL(65,30);
